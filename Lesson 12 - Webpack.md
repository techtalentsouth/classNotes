...
There is a large ecosystem of modules that transform/compile(transpile) html, css and js files in different ways.<br>*It's up to the developer to decide what kind of compilation steps the application needs.*
...
First, you'll want to initialize the your `package.json` file.  Use the following command to get started and follow the prompts.

`npm init`

Next, save webpack as a development dependency by utilizing the command below.  A folder called `node_modules` should have been added along with a file called `package.json`.

`npm install webpack --save-dev` 

[How to use npm global without sudo on OSX](https://johnpapa.net/how-to-use-npm-global-without-sudo-on-osx/)
...
*Note:  In the field it is common to have the following folder pairs

* src and bin 
* src and dist
* src and build
* **app and dist** will be out preference for this course
...
`webpack app/javascript/index.js dist/bundle.js`

if that doesn't work try the following

`./node_modules/.bin/webpack app/javascript/index.js dist/bundle.js`

**OR**.....try this command and see if that works
...
## A little more detail before we get started...
...
# Exercise 1 Answer:
- Initialize your folder: `npm init`
...
- Create your index.html in the source folder with new button
- Create your app.css in the source folder
- Create your js entry file which requires the another.js file
- Create your another.js file 
...
The good news is that webpack offers a configuration file, one of the benefits is you can design specific configuration instructions.
...
## ES6 Syntax in the ES6 Module for Webpack
Remember webpack with babel converts ES6 code to native javascript.  

So far, webpack has been a glorified file copier, how can it help us?

Webpack implements ES6 modules, which let you structure your application modularly by defining what each file exposes or requires. 
...
//Export the student array
export default students;
```

##### File: class.js
```javascript
//import the student array from the students.js file
import students from './students';

var class = {
	name: "JavaScript Application Development",
	students: students //use the array
};
...
With ES6 importing/exporting, we can the import the node modules now as well. 
...
Taking from the npm module **moment.js**.  This module helps you parse, validate, manipulate, and display dates in javascript.
...
//Display the time and date 7 days from now
...
### Locating Modules
If you place modules in different directories, then you can use this property in your **webpack.config.js** file to simplifiy the process.
...
Webpack also offers the ability for us to create a server on our local machine.  This is a little node.js express server that we are utilizing to host the file out of the directory we specify in the command line.  The purpose of this server is to simplify the process of editing your files and reloading the webpage.  For example, if you modify the source files and dev server will redo the webpack process and reload the page.   
